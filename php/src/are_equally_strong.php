...
function are_equally_strong($yourLeft, $yourRight, $friendsLeft, $friendsRight): bool
{
    $yourStrongest = $yourLeft > $yourRight ? $yourLeft : $yourRight;
    $yourWeakest = $yourLeft <= $yourRight ? $yourLeft : $yourRight;
    $friendsStrongest = $friendsLeft > $friendsRight ? $friendsLeft : $friendsRight;
    $friendsWeakest = $friendsLeft <= $friendsRight ? $friendsLeft : $friendsRight;
