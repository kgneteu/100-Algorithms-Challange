// The master launch sequence consists of several independent sequences
// for different systems.
// Your goal is to verify that all the individual system sequences are in strictly
// increasing order. In other words, for any two elements i and j (i < j)
// of the master launch sequence that belong to the same system
...
// and stepNumbers = [1, 10, 11, 2, 12, 111], the output
// should be launchSequenceChecker(systemNames, stepNumbers) = true.
...
// and stepNumbers = [2, 1, 12, 111], the output should be
// launchSequenceChecker(systemNames, stepNumbers) = false.
// There are three independent sequences for systems "stage_1", "stage_2", and "dragon".
// These sequences are [2, 1], [12], and [111], respectively. In the first sequence,
