...
// meaning they always turn right when they hear 'L'
// and left when they hear 'R'.
// The coach wants to know how many times the students end up
// facing the same direction.
//
// Given the list of commands the coach has given,
// count the number of such commands after which the students
...
// solution(commands) = 3.
//
// Let's say that there are 4 students, and the second one can't
...
export function lineUp(commands: string): number {
    let count = 0
    let sameDir = true
