...
// which he's convinced will help clarify things.
// His numeral system has base 26, and its digits are represented by English
...
//
// [output] array.string
// An array of strings in the format "letter1 + letter2",
// where "letter1" and "letter2" are correct one-digit numbers in the new numeral system.
