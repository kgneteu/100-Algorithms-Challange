...
// has only one non-zero digit using a tail rounding approach.
// This means that at each step we take the last non 0 digit
// of the number and round it to 0 or to 10.
// If it's less than 5 we round it to 0
// if it's larger than or equal to 5 we round it to 10
