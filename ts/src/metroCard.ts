// You just bought a public transit card that allows you to ride the Metro
// for a certain number of days.
//
// Here is how it works: upon first receiving the card, the system allocates
// you a 31-day pass, which equals the number of days in January.
...
// how many times your pass has been extended so far.
// However, you do remember the number of days you were able to ride the Metro during
// this most recent month.
...
//
//     There are 30 days in April, June,
//     September and November, so the next months to consider are May, July,
//     October or December.
...
//
// An array of positive integers, the possible number of days
// for which you will extend your pass.
// The elements of the array can only be equal to 28, 30 or
// 31 and must be sorted in increasing order.

export function metroCard(lastNumberOfDays: number): number[] {
    return lastNumberOfDays === 28 ? [31] : lastNumberOfDays === 30 ? [31] : [28, 30, 31];
}
