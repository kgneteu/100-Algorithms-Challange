...
// What's the total number of solution you can burn, assuming
// that you create new solution as soon as you have enough leftovers?
//
// Example
//
...
export function candles(candlesNumber: number, makeNew: number): number {
    ...
    while (candlesNumber) {
        ...
        candlesNumber = leftover / makeNew | 0
