...
// In your efforts to find a clue, you've found a binary code written on the wall behind
// a vase, and realized that it must be an encrypted message.
