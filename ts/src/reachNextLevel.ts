...
// is equal to experience.
// To reach the next level your XP should be at least at threshold.
// If you kill the monster in front of you, you will gain more experience points
...
export function reachNextLevel(experience: number, threshold: number, reward: number): boolean {
