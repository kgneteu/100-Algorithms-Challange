...
// how to add two integers, written one below another,
// column by column.
...
//
// 6 + 4 = 10 but the child forgets about carrying the 1
// and just writes down the 0 in the last column
// 5 + 3 = 8
...
export function additionWithoutCarrying(param1: number, param2: number): number {
    // let result = "";
    // let a = param1.toString();
    // let b = param2.toString();
