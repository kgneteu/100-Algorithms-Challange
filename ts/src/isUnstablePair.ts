// Some file managers sort filenames taking into account
// case of the letters, others compare strings as
// if all of the letters are of the same case.
// That may lead to different ways of filename ordering.
//
// Call two filenames an unstable pair if their ordering depends on the case.
//
// To compare two filenames a and b, find the first position
// i at which a[i] ≠ b[i]. If a[i] < b[i], then a < b.
// Otherwise a > b. If such position doesn't exist,
...
//
// A non-empty string of English letters and digits.
// It's guaranteed that there is no ambiguity, i.e.
// even being considered in the same case strings are never equal.
//
// Guaranteed constraints:
...
// console.log(isUnstablePair("123za","123Z"))
