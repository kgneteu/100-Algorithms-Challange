...
// The first player to win 6 games is declared the winner unless
// their opponent had already won 5 games,
...
//
// Since both players won at least 5 games, the set would've ended once one
// of them won the 7th one.
//
